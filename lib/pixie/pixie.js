(function() {
  ...
  function ListWatcher(target, list, width, height) {
    ...
    this.el = cl('list-watcher', [
      ...
      this.elContents = cl('list-watcher-contents', {tabIndex: -1}, [
    ...
    this.elContents.addEventListener('blur', this.blur.bind(this));
  ...
  ListWatcher.prototype.keyDown = function(e) {
    ...
    if (this.editIndex != null) {
      this.scrollToIndex(this.editIndex, true);
    }
  };

  ListWatcher.prototype.blur = function(e) {
  ...
  CostumesPanel.prototype.newFromEditor = function(file) {
    ...
    this.addCostume(new Costume(this.newCostumeName(), empty, 0, 0, 2));
  };

  CostumesPanel.prototype.newCostumeName = function() {
    return this.sprite.uniqueCostumeName(this.sprite.isStage ? 'backdrop1' : 'costume1');
  };
  ...
  function StagePanel(editor) {
    ...
    this.el = cl('stage-panel stopped', [
      this.elTitleBar = cl('title-bar', [
        ...
        this.runButton = this.makeButton('run', function() {
    ...
    this.el = cl('sprite-panel', [
      this.elTitleBar = cl('title-bar', [
        ...
        this.elNewGroup = cl('new-group', [
          ...
          this.makeNewButton('new-camera', _('New sprite from file'), this.newFromCamera)
        ])
      ]),
      this.elStageSection = cl('stage-section', [
        this.stageIcon.el,
        this.elNewBackdrop = cl('new-backdrop', [_('New backdrop:')])
      ]),
  ...
  function SpriteIcon(panel, sprite) {
    ...
    this.el = cl('sprite-icon', [
      ...
      this.elName = cl('sprite-icon-label', [sprite.name])
    ]);
